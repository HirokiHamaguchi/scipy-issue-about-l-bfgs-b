...
Full commands are in [ENV_MEMO.md](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/ENV_MEMO.md).
...
[`benchmark_lbfgsb.py`](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/benchmark_lbfgsb.py) uses L-BFGS-B without bounds to expose bound-oriented work that remains on the
unconstrained path.
...
Raw results are available for [OpenBLAS](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/results/openblas.json) and [MKL](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/results/mkl.json).
...
With OpenBLAS, I tested [`unconstrained_two_loop.patch`](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/unconstrained_two_loop.patch), a small prototype that replaces the unconstrained part with the standard L-BFGS two-loop recursion when there are no bounds.

### 3-2: Results

Raw results are available for [baseline](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/results/patched-comparison/baseline/openblas.json) and [prototype](https://github.com/HirokiHamaguchi/scipy-issue-blas-in-l-bfgs-b/blob/master/results/patched-comparison/patched-ver1/openblas.json).
